...
describe('Double quotes in default language (en)\n', () => {
	...
	Object.entries(testCase).forEach(([key, value]) => {
		it('module test', () => {
			assert.strictEqual(
				fixDoubleQuotesAndPrimes(key, generateLocale('en-us')),
				value
			)
		})
	})
...
describe('Double quotes in Slovak, Czech and German language (sk, cs, de)\n', () => {
	...
	Object.entries(testCase).forEach(([key, value]) => {
		it('', () => {
			assert.strictEqual(
				fixDoubleQuotesAndPrimes(key, generateLocale('cs')),
				value
			)
			assert.strictEqual(
				fixDoubleQuotesAndPrimes(key, generateLocale('sk')),
				value
			)
		})
	})
...
describe('Double quotes in Rusyn language (rue)\n', () => {
	...
	Object.entries(testCase).forEach(([key, value]) => {
		it('', () => {
			assert.strictEqual(
				fixDoubleQuotesAndPrimes(key, generateLocale('rue')),
				value
			)
		})
	})
