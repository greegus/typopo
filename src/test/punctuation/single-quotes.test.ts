...
describe('Single quotes in default language (en-us)\n', () => {
	...
	Object.entries(testCase).forEach(([key, value]) => {
		it('should fix single quotes, primes and apostrophes in English', () => {
			assert.strictEqual(
				fixSingleQuotesPrimesAndApostrophes(key, generateLocale('en-us')),
				value
			)
		})
	})
...
describe('Single quotes in (sk, cs, de-de)\n', () => {
	...
	Object.entries(testCase).forEach(([key, value]) => {
		it('should fix single quotes, primes and apostrophes in (sk, cs, de-de)', () => {
			assert.strictEqual(
				fixSingleQuotesPrimesAndApostrophes(key, generateLocale('sk')),
				value
			)
			assert.strictEqual(
				fixSingleQuotesPrimesAndApostrophes(key, generateLocale('cs')),
				value
			)
			assert.strictEqual(
				fixSingleQuotesPrimesAndApostrophes(key, generateLocale('de-de')),
				value
			)
		})
	})
...
describe('Single quotes in (rue)\n', () => {
	...
	Object.entries(testCase).forEach(([key, value]) => {
		it('should fix single quotes, primes and apostrophes in Rusyn', () => {
			assert.strictEqual(
				fixSingleQuotesPrimesAndApostrophes(key, generateLocale('rue')),
				value
			)
		})
	})
