...
describe('Fix Initials (sk, cs, rue, de-de)\n', () => {
	...
	Object.entries(testCase).forEach(([key, value]) => {
		it('unit test', () => {
			assert.strictEqual(fixInitials(key, generateLocale('sk')), value)
		})
		it('module test', () => {
			assert.strictEqual(fixAbbreviations(key, generateLocale('sk')), value)
		})
	})
})
...
describe('Fix Initials (en-us)\n', () => {
	...
	Object.entries(testCase).forEach(([key, value]) => {
		it('unit test', () => {
			assert.strictEqual(fixInitials(key, generateLocale('en-us')), value)
		})
		it('module test', () => {
			assert.strictEqual(
				fixAbbreviations(key, generateLocale('en-us')),
				value
			)
		})
	})
...
describe('Fix multiple-word abbreviations (sk, cs, rue, de-de)\n', () => {
	...
	Object.entries(testCase).forEach(([key, value]) => {
		it('unit test', () => {
			assert.strictEqual(
				fixMultipleWordAbbreviations(key, generateLocale('sk')),
				value
			)
		})
		it('module test', () => {
...
describe('Fix multiple-word abbreviations (en-us)\n', () => {
	...
	Object.entries(testCase).forEach(([key, value]) => {
		it('unit test', () => {
			assert.strictEqual(
				fixMultipleWordAbbreviations(key, generateLocale('en-us')),
				value
			)
		})
		it('module test', () => {
...
describe('Fix Single-word abbreviations (sk, cs, rue, de-de, en-us)\n', () => {
	...
	Object.entries(testCase).forEach(([key, value]) => {
		it('unit test', () => {
			assert.strictEqual(
				fixSingleWordAbbreviations(key, generateLocale('sk')),
				value
			)
		})
	})
