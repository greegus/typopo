...
*/
export function fixISSN(string: string, locale: Locale) {
	let pattern =
		'(issn)' +
		'(:?)' +
		'([' +
...
*/
export function fixISBN10(string: string, locale: Locale) {
	let dashedSpace =
		'([' +
		locale.spaces +
		']?[' +
...
/*
	...
	@returns {string} — output with correct ISBN format
*/
export function fixISBN13(string: string, locale: Locale) {
	let dashedSpace =
		'([' +
		locale.spaces +
		']?[' +
...
/*
	...
	@returns {string} — output with correct ISBN format
*/
export function fixISBNnumber(string: string, locale: Locale) {
	let dashedSpace =
		'([' +
		locale.spaces +
		']?[' +
...
*/
export function fixPubId(string: string, locale: Locale) {
