...
*/
export function excludeExceptions(string: string, locale: Locale) {
	/* [1] Identify email adresses */
...
*/
function identifyExceptionSet(string: string, pattern: string) {
...
*/
export function placeExceptions(string: string) {
	for (var i = 0; i < exceptions.length; i++) {
