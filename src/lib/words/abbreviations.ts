...
*/
export function fixInitials(string: string, locale: Locale) {
...

	...
	@returns {string} corrected output
*/
export function fixMultipleWordAbbreviations(string: string, locale: Locale) {
...

	...
	@returns {string} corrected output
*/
export function fixSingleWordAbbreviations(string: string, locale: Locale) {
	/* [1] Change single-word abbreviations from all locales abbr. patterns */
	let abbreviationPatterns = []
...
export function fixAbbreviations(string: string, locale: Locale) {
