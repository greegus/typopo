...
*/
export function fixMultiplicationSignBetweenNumbers(string: string, locale: Locale) {
	let pattern =
		'([' +
...
/*
	...
	* Marciano x Clay → Marciano⎵×⎵Clay		(words)
	...
	@returns {string} — output with replaced and spaced multiplication sign
*/
export function fixMultiplicationSignBetweenWords(string: string, locale: Locale) {
	let pattern =
		'([' +
		locale.allChars +
		']+)' +
...
/*
	...
	* 4X object → 4X⎵object
	...
	@returns {string} — output with replaced and spaced multiplication sign
*/
export function fixMultiplicationSignBetweenNumberAndWord(string: string, locale: Locale) {
	let pattern =
		'([' +
		locale.cardinalNumber +
		'])' +
...
*/
export function fixNbspAroundMultiplicationSign(string: string, locale: Locale) {
	let pattern =
		'([' +
		locale.cardinalNumber +
		']+)' +
...
export function fixMultiplicationSign(string: string, locale: Locale) {
