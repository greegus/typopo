...
*/
export function replaceThreeCharsWithEllipsis(string: string, locale: Locale) {
...
/*
	...
	@returns {string} — output with fixed ellipsis
*/
export function replaceTwoCharsWithEllipsis(string: string, locale: Locale) {
	let pattern =
		'\\.' +
		locale.ellipsis +
		'|' +
...
/*
	...
	@returns {string} — output with fixed ellipsis
*/
export function replaceTwoPeriodsWithEllipsis(string: string, locale: Locale) {
...
*/
export function fixEllipsisSpacingAroundCommas(string: string, locale: Locale) {
	let pattern =
...
*/
export function fixAposiopesisStartingParagraph(string: string, locale: Locale) {
	let pattern =
		'(^…)' +
		'([' +
		locale.spaces +
...
/*
	...
	@returns {string} — output with fixed spacing
*/
export function fixAposiopesisStartingSentence(string: string, locale: Locale) {
	let pattern =
		'([' +
...
/*
	...
	@returns {string} — output with fixed spacing
*/
export function fixAposiopesisBetweenSentences(string: string, locale: Locale) {
	let pattern =
		'([' +
		locale.lowercaseChars +
		'])' +
...
export function fixAposiopesisBetweenWords(string: string, locale: Locale) {
	let pattern =
		'([' +
		locale.allChars +
		'])' +
...
/*
	...
	@returns {string} — output with fixed spacing
*/
export function fixEllipsisBetweenSentences(string: string, locale: Locale) {
...
/*
	...
	@returns {string} — output with fixed spacing
*/
export function fixAposiopesisEndingParagraph(string: string, locale: Locale) {
	let pattern =
		'([' +
		locale.lowercaseChars +
		'])' +
...
export function fixEllipsis(string: string, locale: Locale) {
