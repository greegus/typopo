...
export function removeMultipleSpaces(string: string, locale: Locale) {
...
*/
export function removeSpacesAtParagraphStart(string: string) {
	/* [1] split the lines manually */
...
export function removeSpaceBeforeSentencePausePunctuation(string: string, locale: Locale) {
	let pattern =
		'([' +
		locale.spaces +
		'])([' +
...
*/
export function removeSpaceBeforeTerminalPunctuation(string: string, locale: Locale) {
	let pattern =
		'([' +
		locale.spaces +
		'])' +
...
*/
export function removeSpaceBeforeOrdinalIndicator(string: string, locale: Locale) {
	let pattern =
		'(' +
...
export function removeSpaceAfterOpeningBrackets(string: string, locale: Locale) {
	let pattern =
...
*/
export function addSpaceBeforeOpeningBrackets(string: string, locale: Locale) {
	let pattern =
		'([' +
...
*/
export function addSpaceAfterTerminalPunctuation(string: string, locale: Locale) {
	var pattern =
		'([' +
		locale.lowercaseChars +
		locale.uppercaseChars +
...
*/
export function addSpaceAfterSentencePause(string: string, locale: Locale) {
	var pattern =
		'([' +
		locale.lowercaseChars +
		locale.uppercaseChars +
...
/*
	...
	@returns {string} — output with a space after closing brackets
*/
export function addSpaceAfterClosingBrackets(string: string, locale: Locale) {
	var pattern =
		'([' +
		locale.closingBrackets +
		'])' +
...
export function removeTrailingSpaces(string: string) {
	return string.trim()
}

export function addSpaceBeforeSymbol(string: string, locale: Locale, symbol: string) {
	let pattern =
...
export function fixSpaces(string: string, locale: Locale) {
