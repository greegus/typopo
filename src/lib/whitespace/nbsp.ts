...
export function removeNbspBetweenMultiCharWords(string: string, locale: Locale) {
	let pattern =
		'([' +
...
export function addNbspAfterPreposition(string: string, locale: Locale) {
	let pattern =
		'(^|[' +
		locale.space +
		']|[^' +
...
export function addNbspAfterAmpersand(string: string, locale: Locale) {
	let pattern =
		'([' +
		locale.spaces +
		'])(' +
...
export function addNbspAfterCardinalNumber(string: string, locale: Locale) {
	let pattern =
		'([^' +
		locale.nbsp +
		']|^)(' +
...
export function addNbspAfterOrdinalNumber(string: string, locale: Locale) {
	let pattern =
		'(' +
		locale.cardinalNumber +
		')(' +
...
export function addNbspWithinOrdinalDate(string: string, locale: Locale) {
	let pattern =
		'(' +
		locale.cardinalNumber +
		')(' +
...
export function addNbspAfterRomanNumeral(string: string, locale: Locale) {
...
export function fixNbspForNameWithRegnalNumber(string: string, locale: Locale) {
	let pattern =
		'(\\b[' +
		locale.uppercaseChars +
		'][' +
...
*/
export function addNbspBeforePercent(string: string, locale: Locale) {
	let pattern =
		'([' +
		locale.spaces +
		'])([' +
...
/*
	...
	@returns {string} — output with correctly added non-breaking space
*/
export function addNbspAfterSymbol(string: string, locale: Locale, symbol: string) {
...
/*
	...
	@returns {string} — output with correctly placed non-breaking space
*/
export function replaceSpacesWithNbspAfterSymbol(string: string, locale: Locale, symbol: string) {
	let pattern = '(' + symbol + ')([' + locale.spaces + '])'
	let re = new RegExp(pattern, 'g')
...
/*
	...
	@returns {string} — output with correctly placed non-breaking space
*/
export function fixNbsp(string: string, locale: Locale) {
