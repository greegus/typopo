...
import { Locale, LocaleString } from './types'
...
// */
export function fixTypos(string: string, locale?: LocaleString, configuration: { removeLines?: boolean } = { removeLines: true }): string {
	locale = typeof locale === 'undefined' ? 'en-us' : locale

	let currentLocale: Locale = generateLocale(locale)
